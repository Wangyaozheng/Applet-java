...
Page({
  ...
  onLoad: function (options) {
    ...
    console.log("我的报修记录",myShophelp);
    console.log("我的空教室", myLostGoods);
    console.log("我的失物招领", myGoodsList);
     this.setData({
       myShophelp: myShophelp,
       myLostGoods: myLostGoods,
       myGoodsList: myGoodsList
